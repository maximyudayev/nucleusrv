...
#define CORE_COUNT 1      // From Top.scala NRVDriver
...
int main(int argc, char **argv, char **env) {
    ...
    Verilated::mkdir("out/nucleusrv.components.NRVDriver_1core/logs");
    ...
    tfp->open("out/nucleusrv.components.NRVDriver_1core/logs/top.vcd");
